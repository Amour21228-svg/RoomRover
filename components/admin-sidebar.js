class CustomAdminSidebar extends HTMLElement {
    connectedCallback() {
        ...
        const userDisplayName = user ? `${user.firstName} ${user.lastName}` : 'Administrateur';
        ...
        this.innerHTML = `
            ...
            <aside class="w-64 bg-white dark:bg-gray-800 shadow-md h-screen fixed">
                ...
                <nav class="p-4 space-y-1">
                    <a href="./admin.html" class="sidebar-link active flex items-center space-x-3 px-3 py-2 rounded-lg font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <a href="./pages/contact.html" class="sidebar-link flex items-center space-x-3 px-3 py-2 rounded-lg font-medium text-gray-700 dark:text-gray-300">
